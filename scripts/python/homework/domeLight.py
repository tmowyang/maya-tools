...
def process():
  ...
  cmds.window(dlWin, width=winWidth, height=winHeight, sizeable=False, menuBar=True, title="Dome Light")

  cmds.menu(label="Help")
  cmds.menuItem(label="About...", command="from homework import lightRigUI;lightRigUI.glr_aboutWin()")
